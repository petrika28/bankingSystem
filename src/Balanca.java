        ...
        try {
            ...
            switch (actionType) {
                ...
                case "transfero":
                    ...
                    } else if (!ActionService.CheckTransfer(receiver)) {
                        new Popup("Klienti nuk ekziston");
                    } else {
                        String message=ActionService.transfer(client,receiver,amount,receiver.getName(),receiver.getSurname());
